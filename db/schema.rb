...
ActiveRecord::Schema.define(version: 2020_12_10_072854) do
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.bigint "user_classifications_id", null: false
    t.string "company_name"
    t.boolean "delete_flag"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_classifications_id"], name: "index_users_on_user_classifications_id"
  end

  add_foreign_key "users", "user_classifications", column: "user_classifications_id"
end
